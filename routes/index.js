...
router.delete('/api/call-logs', async (req, res) => {
  try {
    ...
    res.send('Are you sure you want to delete all call logs? Type "DELETE" to confirm.');
    ...
    console.error(err);
    res.status(500).send('Error deleting all call logs from MySQL using Sequelize');
  }
});
